...
class ReportBugActivity : BaseActivity() {
    ...
    private fun submitBugReport(category: String, description: String) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                // Save to Firestore or simulate successful dispatch
                ...
                Log.e("ReportBugActivity", "Failed to save bug report to Firebase", e)
            }

            withContext(Dispatchers.Main) {
                binding.loadingOverlay.visibility = View.GONE
                Toast.makeText(this@ReportBugActivity, "Bug report submitted successfully! Thank you.", Toast.LENGTH_LONG).show()
